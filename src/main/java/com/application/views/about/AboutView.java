    ...
    public AboutView() {
        ...
        add(new TextArea() {{
            setValue("This application is in development. The development roadmap is:\n"
                    ...
                    +"Map the graph generated to the coordinate system used in X4 and construct the Cluster array in Galaxy from Celludriel's model -> in progress\n"
                    +"Get user input on factions, minor factions\n"
                    +"Assign faction locations, place stations\n"
                    +"Assign sector resources, populations, zones\n"
                    +"Potentially generate faction jobs for the generated map (may be impossible)\n"
